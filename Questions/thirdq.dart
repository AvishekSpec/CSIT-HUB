        ...
        body: Center(
          child: ListView(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () async {
                    final url = '3rdsem/data_structure.pdf';
                ...
                GestureDetector(
                  onTap: () async {
                    final url = '3rdsem/numerical_method.pdf';
                    final file = await PDFApi.loadFirebase(url);
                ...
                GestureDetector(
                  onTap: () async {
                    final url = '3rdsem/computer_architecture.pdf';
                    final file = await PDFApi.loadFirebase(url);
                ...
                GestureDetector(
                  onTap: () async {
                    final url = '3rdsem/computer_graphics.pdf';
                    final file = await PDFApi.loadFirebase(url);
                ...
                GestureDetector(
                  onTap: () async {
                    final url = '3rdsem/statisticsII.pdf';
                    final file = await PDFApi.loadFirebase(url);
